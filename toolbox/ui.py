...
import temp_whisper as whisp
import nllb_200 as nlb
...
class UI(QDialog):
    ...
    def save_recorded_audio(self, wav, sample_rate):
        # Specify the output folder path where you want to save the recorded audio
        output_folder_path = "D:\\Capstone\\Blabber\\blabber_models\\voice_cloning\\recorded audio"
        ...
        file_name = "recorded_audio.wav"  # You can specify the desired file name
    ...
    def record_one(self, sample_rate, duration):
        ...
        self.save_recorded_audio(wav, sample_rate)
        whisp.asr()
        nlb.trans()
        return wav.squeeze()
    ...
    def __init__(self):
        ...
        ## Generation
        self.text_prompt = QPlainTextEdit(default_text)#translated text
        gen_layout.addWidget(self.text_prompt, stretch=1)

        # Add the button to load a text file
        load_file_button = QPushButton("Load Text File")
        load_file_button.clicked.connect(self.load_text_file)
        gen_layout.addWidget(load_file_button)
